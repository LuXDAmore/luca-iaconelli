<template>
    <GridLayout rows="auto, *" class="sidedrawer sidedrawer-left">
        <StackLayout row="0" class="sidedrawer-header">
            <Label class="sidedrawer-header-image fa" text.decode="&#xf2bd;" />
        ...
        <ScrollView row="1" class="sidedrawer-content">
            <StackLayout>
                ...
                <GridLayout
                    columns="auto, *"
                    :class="'sidedrawer-list-item' + (selectedPage === 'Browse' ? ' selected': '')"
                ...
                <GridLayout
                    columns="auto, *"
                    :class="'sidedrawer-list-item' + (selectedPage === 'Search' ? ' selected': '')"
                ...
                <GridLayout
                    columns="auto, *"
                    :class="'sidedrawer-list-item' + (selectedPage === 'Featured' ? ' selected': '')"
                ...
                <GridLayout
                    columns="auto, *"
                    :class="'sidedrawer-list-item' + (selectedPage === 'Settings' ? ' selected': '')"
